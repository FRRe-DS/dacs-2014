...
public class ObjectFactory {
    ...
    private final static QName _Sum_QNAME = new QName("http://server.ws.dacs.frre.utn.edu.ar/", "sum");
    private final static QName _SumResponse_QNAME = new QName("http://server.ws.dacs.frre.utn.edu.ar/", "sumResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ws.dacs.frre.utn.edu.ar/", name = "sum")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ws.dacs.frre.utn.edu.ar/", name = "sumResponse")
